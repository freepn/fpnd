...
those DNS servers, but you have no idea how much data they log or where
...
In order to recitify the problem you'll need to collect some system info:
...
Underneath everything you most likely have a netplan cconfguration file
...
What can we see from the above output?
